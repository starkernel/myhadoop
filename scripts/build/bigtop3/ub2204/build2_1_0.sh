...
echo "############## PRE BUILD BIGTOP_2_1_0 start #############"
...
# 定义一个包含所有补丁文件路径的数组
patch_files=(
  "/scripts/build/bigtop3/common/patch2_1_0/patch0-BASE-FIXED.diff"
  "/scripts/build/bigtop3/common/patch2_1_0/patch1-HADOOP-DEB-SUP.diff"
)
...
echo "############## PRE BUILD BIGTOP_2_1_0 end #############" -d
